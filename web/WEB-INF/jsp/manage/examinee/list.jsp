		...
		<div class="main-wrap">
			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i><a href="${ctx }/manage/view/index">首页</a><span
						class="crumb-step">&gt;</span><span class="crumb-name">考生管理</span>
				</div>
			</div>
				...
				<form name="myform" id="myform" method="post">
					<div class="result-title">
						<div class="result-list">
							<a href="${ctx }/manage/view/examineeToAdd"><i
								class="icon-font"></i>新增作品</a> <a id="batchDel"
						...
						<table class="result-tab" width="100%">
							...
							<tr>
								<td class="tc"><input name="id[]" value="58"
									type="checkbox"></td>
								<td><input name="ids[]" value="58" type="hidden"> <input
									class="common-input sort-input" name="ord[]" value="0"
									type="text"></td>
								<td>58</td>
